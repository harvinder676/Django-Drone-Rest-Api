...
class DroneCategory(models.Model):
	""" Create a Model for the drone category table"""
...
class Drone(models.Model):
    """ Create a model for the drone table"""
	# Field of the Drone table
    name = models.CharField(max_length=250,unique=True)
	# Foreign Key to drone category
...
class Pilot(models.Model):
	""" Create a model for the Pilot Table"""
	MALE = "M"
	FEMALE = "F"
	GENDER_CHOICES = (
		(MALE, 'Male'),
...
class Competition(models.Model):
	""" Create models for the competitions table"""
